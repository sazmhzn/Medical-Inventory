...
const Footer = () => {
  return (
    <footer className="w-full bg-[#333333] justify-center items-center inline-flex">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
          <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
            ...
            <p className="py-8 text-sm text-white lg:max-w-xs text-center lg:text-left">
              At CleverDev Software we create custom solutions for small and
              mid-sized enterprises, and render business automation services,
              using time-proven technologies and approaches.
            </p>
            <article>
              <div className="w-80 h-[429px] relative bg-white/5 rounded-2xl shadow">
                <div className="w-[179.32px] h-7 left-[32px] top-[24px] absolute text-white text-xl font-bold font-['Inter'] leading-7">
                  Find Us in the USA
                </div>
                <div className="w-[241.12px] h-[45px] left-[32px] top-[65px] absolute text-white text-sm font-normal font-['Inter'] leading-7">
                  5900 Balcones Drive STE 100 Austin
                  <br />
                  TX 78731
                </div>
                <div className="h-6 py-0.5 left-[32px] top-[124px] absolute justify-center items-center inline-flex">
                  <div className="w-[130.84px] h-5 text-white text-base font-bold font-['Inter'] leading-normal">
                    +1 214 736 3425
                  </div>
                </div>
                <div className="w-[169.52px] h-7 left-[32px] top-[188px] absolute text-white text-xl font-bold font-['Inter'] leading-7">
                  Find Us in Europe
                </div>
                <div className="w-[54.08px] h-6 left-[32px] top-[224px] absolute text-white text-base font-bold font-['Inter'] leading-normal">
                  Poland
                </div>
                <div className="w-[250.49px] h-7 left-[32px] top-[248px] absolute text-white text-sm font-normal font-['Inter'] leading-7">
                  101 Ostrobramska Str 04-041 Warsaw
                </div>
                <div className="w-64 h-px left-[32px] top-[324px] absolute bg-white/25" />
                <div className="w-[249.33px] h-6 py-0.5 left-[32px] top-[341px] absolute justify-center items-center inline-flex">
                  <div className="w-[249.72px] h-5 text-white text-base font-normal font-['Inter'] leading-normal">
                    contact@cleverdevsoftware.com
                  </div>
                </div>
                <div className="w-6 h-6 left-[32px] top-[381px] absolute justify-center items-center inline-flex">
                  <div className="grow shrink basis-0 self-stretch justify-center items-center inline-flex">
                    <div className="w-[24.34px] h-6 text-white text-2xl font-normal font-['Font Awesome 5 Brands'] leading-normal">
                      
                    </div>
                  </div>
                </div>
                <div className="w-6 h-6 left-[80px] top-[381px] absolute justify-center items-center inline-flex">
                  <div className="grow shrink basis-0 self-stretch pr-[2.67px] justify-center items-center inline-flex">
                    <div className="w-[21.33px] h-6 text-white text-2xl font-normal font-['Font Awesome 5 Brands'] leading-normal">
                      
                    </div>
                  </div>
                </div>
                <div className="w-6 h-6 left-[128px] top-[381px] absolute justify-center items-center inline-flex">
                  <div className="grow shrink basis-0 self-stretch pr-[8.62px] justify-start items-center inline-flex">
                    <div className="w-[15.38px] h-6 text-white text-2xl font-normal font-['Font Awesome 5 Brands'] leading-normal">
                      
                    </div>
                  </div>
                </div>
